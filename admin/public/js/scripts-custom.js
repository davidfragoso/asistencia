...
//----------------------------------------------------------------------------------------------
                ...
                $('.savetask').on('click', function(){
                    ...
                    var materia = $('#namemateria').val();
                    var taller = $('#nametaller').val();
                    var color = $('#idcolortask option:selected').val();
                    $('#DataEdit').modal('toggle');
                    $('#'+tede).append('<label class="label-desc '+color+'">'+tasker+'<br>'+materia+'<br>'+taller+' <a class="deltasker"><i class="fa fa-times"></i></a></label>');
                ...
                $('.guardarhorario').on('click', function(){
                    ...
                    var taller = $('#tallerinput').val();
                    var horario = $('#edithorariotabledata').html();
                    var iddata = $('#inputidedit').val();
                    var horariodata = 'process=4&nombre='+nombre+'&descripcion='+descripcion+'&materia='+materia+taller+'&horario='+horario+'&id='+iddata;
