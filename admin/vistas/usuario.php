...
<div class="box-header with-border">
  <h1 class="box-title">Usuarios</a> <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle fa fa-user-plus"></i> Agregar</button></h1>
