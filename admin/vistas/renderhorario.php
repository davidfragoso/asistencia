...
<div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content" style="padding: 50px 25px 50px 25px; max-width:70%">
        <!-- Default box -->
        ...
        <div id="edithorariotabledata">
            <div class="row">
                ...
                <div class="panel-body contentHorario table-responsive">
                            ...
                            <tr id="tr67410b14a455c4a3072c0d6e126e5bf6b47f9067">
                                ...
                                <td class="td-time">
                                    ...
                                    <div id="parent67410b14a455c4a3072c0d6e126e5bf6b47f9067" class="timeblock" style="display: block;">
                                        <strong id="data67410b14a455c4a3072c0d6e126e5bf6b47f9067" class="animated">10:50 am - 11:40 pm</strong>
                            ...
                            <tr id="trd427cd5f6ce7166030771618e763a33494765f1d">
                                ...
                                <td class="td-time">
                                    ...
                                    <div id="parentd427cd5f6ce7166030771618e763a33494765f1d" class="timeblock" style="display: block;">
                                        <strong id="datad427cd5f6ce7166030771618e763a33494765f1d" class="animated">11:40 pm - 12:30 pm</strong>
                    ...
                    <input type="hidden" id="descripcioninput" value="Cocina">
                    <input type="hidden" id="nombreinput" value="GA-31">
